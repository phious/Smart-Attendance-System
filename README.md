...
## FLOW DIAGRAM
<p align = "center">
<img src = "https://github.com/phious/Smart-Attendance-System/blob/master/Screenshots/Blank%20board.png" height="400">
 </p>
 
 ## INSTALLATION 
 Use Import from Version Control in Android Studio or Clone repo and open the project in Android Studio.
 ```bash
git clone git@github.com:phious/Smart-Attendance-System.git
```
